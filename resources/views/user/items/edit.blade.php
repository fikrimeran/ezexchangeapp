        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-5">
                    ...
                    <form action="{{ route('items.update', $item) }}" method="POST" enctype="multipart/form-data" class="row g-4">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-12 text-center">
                            ...
                            <img id="image_preview"
                                ...
                                style="max-width: 250px; {{ $item->item_image ? '' : 'display: none;' }}">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="item_description"
                                      ...
                                      required>{{ old('item_description', $item->item_description) }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <input type="text"
                                       id="item_location"
                                       name="item_location"
                                       value="{{ old('item_location', $item->item_location) }}"
...
// ✅ Subcategory fetcher + preselected
document.addEventListener("DOMContentLoaded", function() {
    ...
    const preselectedSubcategory = "{{ $item->subcategory_id ?? '' }}";
    if (preselectedCategory) {
        loadSubcategories(preselectedCategory, preselectedSubcategory);
    }

    const savedLat = parseFloat("{{ $item->latitude ?? '' }}");
    const savedLng = parseFloat("{{ $item->longitude ?? '' }}");
